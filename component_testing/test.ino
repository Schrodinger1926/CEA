...
const int waterlevel = A9; //Sensor AO pin to Arduino pin A0
float value;          //Variable to store the incomming data
...
void loop()
{
  value = ((analogRead(waterlevel))/1023.0)*100; //Read data from analog pin and store it to value variable
//  
//  if (value<=480){ 
